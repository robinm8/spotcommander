...
if(isset($_GET['featured-playlists']))
{
	...
	$files = get_external_files(array(project_website . 'api/1/browse/featured-playlists/?time=' . time() . '&country=' . $country . '&fields=' . rawurlencode('description,playlists')), null, null);
...
elseif(isset($_GET['popular-playlists']))
{
	...
	else
	{
		...
		foreach($playlists as $playlist)
		{
			...
			echo '<div title="' . hsc($description) . '" class="card_vertical_div actions_div" data-actions="browse_playlist" data-uri="' . $uri . '" data-description="' . base64_encode($description) . '" data-isauthorizedwithspotify="' . is_authorized_with_spotify . '" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_vertical_cover_art_div" style="background-image: url(\'' . $cover_art . '\')"></div><div class="card_vertical_upper_div">' . hsc($name) . '</div><div class="card_vertical_lower_div">' . hsc($genre) . '</div></div>';
		}
...
elseif(isset($_GET['charts']))
{
	...
	if(empty($metadata['tracks']))
	{
		...
		echo '
			...
			<div id="activity_message_div"><div><div class="img_div img_64_div information_64_img_div"></div></div><div>Could not get chart. Try again.</div></div>
	...
	else
	{
		...
		$activity['actions'][] = array('action' => array('Queue Tracks Randomly', ''), 'keys' => array('actions', 'uris', 'randomly'), 'values' => array('hide_dialog queue_uris', $queue_uris, 'true'));
...
elseif(isset($_GET['news']))
{
	...
	if(empty($metadata['news']))
	{
		...
		echo '
			...
			<div id="activity_message_div"><div><div class="img_div img_64_div information_64_img_div"></div></div><div>Could not get news. Try again.</div></div>
	...
	else
	{
		...
		else
		{
			...
			foreach($articles as $id => $article)
			{
				...
				echo '<div title="' . hsc($headline) . '" class="card_vertical_div actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="news" data-args="id=' . $id . '" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_vertical_cover_art_div" style="background-image: url(\'' . $cover_art . '\')"></div><div class="card_vertical_upper_tall_div">' . hsc($headline) . '</div><div class="card_vertical_lower_div">' . hsc($date) . '</div></div>';
			}
...
else
{
	...
	echo '
		...
		<div id="browse_featured_playlists_div" class="actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="featured-playlists" data-args="" data-country="' . $country_code . '" onclick="void(0)"><div><div></div></div></div>
		...
		<div class="card_div actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="genres" data-args="" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div genres_24_img_div"></div></div><div class="card_text_div"><div>Genres &amp; Moods</div><div>Playlists based on genres and moods.</div></div></div>
		...
		<div class="card_div actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="charts" data-args="chart=viral" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div share_24_img_div"></div></div><div class="card_text_div"><div>Most Viral</div><div>Last week in ' . $country . '.</div></div></div>
		<div class="card_div actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="news" data-args="" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div news_24_img_div"></div></div><div class="card_text_div"><div>News</div><div>Latest music news in ' . $country . '.</div></div></div>
		</div>
		</div>
		</div>
