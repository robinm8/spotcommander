...
elseif(isset($_GET['search']))
{
	...
	else
	{
		...
		if(is_array($tracks))
		{
			...
			{
				echo '<div id="green_button_show_all_search_results_div" class="green_button_div green_button_below_list_div actions_div" data-actions="show_all_list_items" data-showitems="div.list_item_track_div" data-hideitem="div#green_button_show_all_search_results_div" data-highlightclass="light_green_highlight" onclick="void(0)">Show All Tracks</div>';
			}
...
else
{
	...
	$activity['actions'][] = array('action' => array('Clear Recent Searches', 'delete_32_img_div'), 'keys' => array('actions'), 'values' => array('clear_recent_searches'));
