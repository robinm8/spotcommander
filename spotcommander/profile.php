...
elseif(isset($_GET['spotify_token']))
{
	...
	if(is_authorized_with_spotify())
	{
		echo '
			...
			<div id="activity_message_div"><div><div class="img_div img_64_div information_64_img_div"></div></div><div>Success! You are now authorized with Spotify.</div></div>
...
else
{
	...
	else
	{
		...
		echo '
			...
			<div><b>Country:</b> ' . get_country_name($profile['country']) . '</div>
