...
<div id="top_actionbar_inner_left_div"><div><div title="Menu" class="actions_div" data-actions="toggle_menu" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div menu_32_img_div"></div></div></div></div>
...
<div id="bottom_actionbar_inner_left_div"><div><div title="Play/Pause" class="actions_div" data-actions="remote_control" data-remotecontrol="play_pause" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div play_32_img_div"></div></div></div></div>
<div id="bottom_actionbar_inner_center_div" class="actions_div" data-actions="toggle_nowplaying" data-highlightotherelement="div#bottom_actionbar_inner_div" data-highlightotherelementparent="div#bottom_actionbar_div" data-highlightotherelementclass="darker_grey_highlight" onclick="void(0)"><div></div></div>
<div id="bottom_actionbar_inner_right_div"><div><div title="Refresh" class="actions_div" data-actions="refresh_nowplaying" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div reload_32_img_div"></div></div></div></div>
</div>
</div>
...
<div class="menu_item_div menu_big_item_div actions_div" data-actions="change_activity" data-activity="library" data-subactivity="" data-args="" data-highlightclass="dark_grey_highlight" onclick="void(0)"><div class="menu_big_item_indicator_div"></div><div class="menu_big_item_icon_div"><div class="img_div img_48_div library_48_img_div"></div></div><div class="menu_big_item_text_div">Library</div></div>
<div class="menu_item_div menu_big_item_div actions_div" data-actions="change_activity" data-activity="browse" data-subactivity="" data-args="" data-highlightclass="dark_grey_highlight" onclick="void(0)"><div class="menu_big_item_indicator_div"></div><div class="menu_big_item_icon_div"><div class="img_div img_48_div browse_48_img_div"></div></div><div class="menu_big_item_text_div">Browse</div></div>
...
<div id="menu_first_small_item_div" class="menu_item_div menu_small_item_div actions_div" data-actions="change_activity" data-activity="profile" data-subactivity="" data-args="" data-highlightclass="dark_grey_highlight" onclick="void(0)"><div><div class="img_div img_24_div profile_24_img_div"></div></div><div>PROFILE</div></div>
<div class="menu_item_div menu_small_item_div actions_div" data-actions="change_activity" data-activity="settings" data-subactivity="" data-args="" data-highlightclass="dark_grey_highlight" onclick="void(0)"><div><div id="update_available_indicator_div" class="img_div img_24_div settings_24_img_div"></div></div><div>SETTINGS</div></div>
...
<div id="nowplaying_actionbar_left_div"><div title="Launch/Quit Spotify" class="actions_div" data-actions="remote_control" data-remotecontrol="launch_quit" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div power_32_img_div"></div></div></div>
<div id="nowplaying_actionbar_right_div"><div title="More" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div overflow_32_img_div"></div></div></div>
...
<div id="nowplaying_volume_buttons_div"><div id="nowplaying_volume_buttons_inner_div"><div title="Mute" class="actions_div" data-actions="adjust_volume" data-volume="mute" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div volume_mute_32_img_div"></div></div><div title="Volume Down" class="actions_div" data-actions="adjust_volume" data-volume="down" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div volume_down_32_img_div"></div></div><div title="Volume Up" class="actions_div" data-actions="adjust_volume" data-volume="up" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_32_div volume_up_32_img_div"></div></div></div></div>
</div>
<div id="nowplaying_volume_level_div"><span id="nowplaying_volume_level_span">50</span> %</div>
</div>
<div id="nowplaying_remote_div">
<div title="Toggle Shuffle" class="actions_div" data-actions="toggle_shuffle_repeat" data-remotecontrol="toggle_shuffle" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_24_div shuffle_24_img_div"></div></div>
<div title="Previous" class="actions_div" data-actions="remote_control" data-remotecontrol="previous" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_48_div previous_48_img_div"></div></div>
<div title="Play/Pause" class="actions_div" data-actions="remote_control" data-remotecontrol="play_pause" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div id="nowplaying_play_pause_div" class="img_div img_64_div play_64_img_div"></div></div>
<div title="Next" class="actions_div" data-actions="remote_control" data-remotecontrol="next" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_48_div next_48_img_div"></div></div>
<div title="Toggle Repeat" class="actions_div" data-actions="toggle_shuffle_repeat" data-remotecontrol="toggle_repeat" data-highlightclass="darker_grey_highlight" onclick="void(0)"><div class="img_div img_24_div repeat_24_img_div"></div></div>
</div>
</div>
</div>
</div>
