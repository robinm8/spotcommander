...
elseif(isset($_GET['most-streamed-viral']))
{
	$chart = $_GET['chart'];
	...
	$activity = array();
	$activity['title'] = 'Most ' . ucfirst($chart) . ' in ' . $metadata['country'];
	...
	else
	{
		...
		foreach($tracks as $track)
		{
			...
			$details_dialog['details'][] = array('detail' => 'Plays', 'value' => number_format($plays, 0, '.', ','));
...
else
{
	...
	echo '
		...
		<div class="card_div actions_div" data-actions="change_activity" data-activity="discover" data-subactivity="most-streamed-viral" data-args="chart=streamed" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div headphones_24_img_div"></div></div><div class="card_text_div"><div>Most Streamed</div><div>Last week in ' . $country . '.</div></div></div>
		<div class="card_div actions_div" data-actions="change_activity" data-activity="discover" data-subactivity="most-streamed-viral" data-args="chart=viral" data-highlightclass="card_highlight" onclick="void(0)"><div class="card_icon_div"><div class="img_div img_24_div share_24_img_div"></div></div><div class="card_text_div"><div>Most Viral</div><div>Last week in ' . $country . '.</div></div></div>
		</div>
		</div>
		</div>
